...
const ForgotPasswordPage = () => {
  ...
  const handleForgotPasswordSubmit = async (e) => {
    ...
    try {
      ...
      setModalDescription(
        `We've sent password reset instructions to **${email}**. Please check your email and follow the instructions to reset your password. If you don't see the email, check your spam folder.`
      );
  ...
  const renderResetForm = () => (
    <>
      ...
      <p className="forgot-subtitle">Enter your new password below to secure your account.</p>

      <form className="login-form forgot-password-form" onSubmit={handleResetPasswordSubmit} noValidate>
        ...
        <div className="password-strength" aria-live="polite">
          ...
          <span className="strength-text" style={{ color: passwordStrength ? passwordStrength.color : "transparent" }}>
  ...
  const renderForgotPasswordForm = () => (
    <>
      ...
      <form className="login-form forgot-password-form" onSubmit={handleForgotPasswordSubmit} noValidate>
  ...
  return (
    <div className="login-wrapper forgot-password-page">
      ...
      <div className="login-right">{isResetMode ? renderResetForm() : renderForgotPasswordForm()}</div>
