// ============================================================================
// RETIRED — Legacy caregiver Orders detail page.
//
// This screen belonged to the old competitive-order flow. It has been
// replaced by the package-model "My Assignments" experience
// (src/main-app/pages/care-giver/assignments/). The route that used to
// render this component now shows a FeatureMovedNotice instead
// (see care-giver-routes.jsx).
//
// The entire file below is commented out on purpose, not deleted, so it
// can be restored if the legacy order flow is ever needed again. To
// restore: uncomment this file, restore its import + <Route> in
// care-giver-routes.jsx.
// ============================================================================
...
//
//     const isOrderPaid = !!(order?.transactionId || order?.paymentTransactionId);
//
//     const bannerTitle = (() => {
//         if (isTasksReady) return 'Task Tracker';
//         if (!contract) return isOrderPaid ? 'Contract Tools Unavailable' : 'Waiting for Payment';
...
//         if (!contract) return isOrderPaid ? 'Task negotiation for this order is being rebuilt.' : 'Waiting for client payment before this order can proceed.';
...
//                                 <div className="cod-contract-state">
//                                     <div className="cod-contract-icon">📋</div>
//                                     <h2>Contract Tools Unavailable</h2>
//                                     <p className="cod-contract-note">
//                                         Task negotiation for this order is being rebuilt. Contact your client directly via message for now.
//                                     </p>
//                                 </div>
//                             ) : (
//                                 <div className="cod-contract-state">
...
//                                     <p className="cod-contract-note">Waiting for client payment before this order can proceed.</p>
//                                 </div>
//                             )}
//                         </div>
//                     )}
