...
import convertFileToBase64 from "../../care-giver/verification/convertFileToBase64";
    ...
    <div className="verification-container">
      ...
      <div className="verification-card">
        ...
        <p className="verification-intro">
          To ensure the safety of our caregivers and maintain high-quality service,
          we require all clients to verify their identity.
        </p>
