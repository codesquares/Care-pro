// ============================================================================
// RETIRED — Admin "Care Matching" tool.
//
// This screen let support staff pick a caregiver's gig and email it to a
// client (POST /Admins/RecommendGig), introducing the client to a specific,
// named caregiver. The pivot assigns caregivers internally through the
// Assignment Console (src/main-app/pages/admin/assignment-console/), so a
// client is never introduced to a named caregiver this way. The backend
// endpoint has been removed and the route now shows a FeatureMovedNotice
// (see admin-routes.jsx).
//
// The entire file below is commented out on purpose, not deleted, so it can
// be restored if ever needed. To restore: uncomment this file, restore its
// import + <Route> in admin-routes.jsx and the sidebar entry in
// AdminSidebar.jsx, and re-enable POST /Admins/RecommendGig on the backend.
// ============================================================================
