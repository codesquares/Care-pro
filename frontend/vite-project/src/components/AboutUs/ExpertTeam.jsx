...
import funmilola from "../../assets/Lolaidowu.jpg"; // Placeholder for expert images
...
const ExpertTeam = () => {
  const experts = [
    ...
    { name: "Nrs.Lola Idowu, RN Canada, Nigeria, US  ", role: "Director of Home Care", discription: "Over five years of expertise in disability and geriatric care.", imgSrc: funmilola },
  ];
